...
def test_teuthology_logs(num_runs:int,num_jobs:int,selection:int, flag_set:str,capsys:pytest.CaptureFixture,monkeypatch:pytest.MonkeyPatch,caplog:pytest.LogCaptureFixture) -> int:     
    ...
    flag_set (str): Flag to set log file path.
